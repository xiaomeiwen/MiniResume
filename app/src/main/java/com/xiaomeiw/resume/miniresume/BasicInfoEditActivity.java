...
public class BasicInfoEditActivity extends EditBasicActivity<BasicInfo> {
    ...
    protected void setupUIForEdit(@NonNull BasicInfo data) {
        ...
        ImageButton add_pic = (ImageButton) findViewById(R.id.basic_info_edit_image);
        add_pic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.i("error","YOu click");
